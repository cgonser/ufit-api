...
{
    public function __construct(private PagarmeTransactionResponseProcessor $pagarmeTransactionResponseProcessor, private LoggerInterface $logger)
    {
    }

    public function __invoke(PagarmeTransactionResponseReceivedEvent $pagarmeTransactionResponseReceivedEvent)
    {
        $this->logger->info('payment.transaction.response', (array) $pagarmeTransactionResponseReceivedEvent->getResponse());
